        ...
        <div className="mt-10">
          <div className="container">
            <table className="cart-table table-auto w-full md:rounded-xl md:overflow-hidden">
              <thead className="text-[18px] font-caustensemi_bold bg-blueBar text-white uppercase h-[74px]">
            ...
            <div className="container py-10">
              <div className="flex flex-col md:flex-row justify-between">
                <div className="w-full md:w-1/2 xl:w-1/3">
                  ...
                  <button className="hidden md:block bg-blueBar border-border text-white px-8 py-2 rounded-lg mt-5">
                    Continue Shopping
                  </button>
                </div>
